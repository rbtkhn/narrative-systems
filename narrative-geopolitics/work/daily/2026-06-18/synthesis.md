...
| --- | --- | --- | --- |
| `NG-20260618-F01` | Within 30 days of `2026-06-18`, the contested leverage structure visible in this day packet will still be visible through renewed bargaining stress, implementation disputes, or another coercive signaling cycle. | `likely` | `2026-07-18` |
