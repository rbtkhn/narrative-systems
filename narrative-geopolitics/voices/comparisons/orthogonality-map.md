...
| [Davis](../davis/README.md) | Practical room / military feasibility | Implementation proof, negotiation clock, force constraint, host feasibility test | What can force still do, what can coercion no longer recover, and what bargaining room is real? | Over-practical skepticism or underweighting structure, legitimacy, and order-transition effects. |
...
| Pape x Davis | Forecast mechanism gets checked against implementation proof and military feasibility. |
...
| Mercouris x Davis | Diplomatic room gets checked against practical bargaining room, public terms, and implementation constraints. |
...
| Mearsheimer x Davis | Structural incentive analysis gets grounded in military feasibility and bargaining limits. |
| Marandi x Diesen | Iran-facing red-line logic gets checked against wider Eurasian/order-transition framing. |
| Marandi x Davis | Iran-facing resistance and legitimacy claims get checked against U.S.-side force limits and operational evidence. |
| Diesen x Davis | Order-transition framing gets checked against practical force constraint and what can actually work. |
...
2. Ask which axis is primary: mechanism, room, structure, red line, order transition, or practical room.
...
Do not collapse Davis into Pape, Mearsheimer, Mercouris, or Diesen. Davis owns practical-room and military-feasibility testing: what force can still do, what coercion can no longer recover, and what bargaining room is implementable.
